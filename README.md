...
3. Scroll down the page until you see **304 API Protection** on the left

![image](https://user-images.githubusercontent.com/51786870/210808725-9b2f8e36-48db-410f-b31b-9dcf45bd319a.png)

3. Hover over tile **Deploy an API Protection Profile**. A start and stop icon should appear within the tile. Click the **Play** Button to start the automation to build the environment
...
3. Enter the command **tail -f /var/log/apm**. Hit enter a few times to create some space on the screen
